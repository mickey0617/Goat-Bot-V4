...
module.exports = {
  config: {
    ...
    countDown: 15,
    role: 0,
    shortDescription: "Generate images by Dalle4",
    longDescription: "Generate images by Dalle4",
    category: "download",
    guide: {
      en: "{pn} prompt"
    }
  ...
  onStart: async function ({ api, message, args }) {
    try {
      ...
      const data2 = {
        prompt: p,
        cookie: "19bdj3pUmCMff6kG8U8vxDgjpYcptzveInamvZNPz90k1XEzhkXPNz7UwQ1IqwZ6DoYypB277XCaVpUi0ETooaGt6qlj8MR7AoaKYdYXPlmuS5k68L6z5-oIbSnOPga_GWgMvaEPWEllgkkLL0J4tikznzYS1haE0vXx62vYoYUJeLVjM_Yp9FI_pJciY08_RIMyu86BU33YmP1GjygPDwA"
      };
